...
class Student:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Student Management System", bd=10, relief=GROOVE,
                      font=("times new roman", 40, "bold"), bg="yellow", fg="blue")
        ...
        addbtn = Button(btn_Frame, text="Add", width=9, command=self.add_students).grid(row=0, column=0, padx=10,
                                                                                        pady=9)
        updatebtn = Button(btn_Frame, text="Update", width=9, command=self.update_data).grid(row=0, column=1, padx=10,
                                                                                             pady=9)
        deletebtn = Button(btn_Frame, text="Delete", width=9, command=self.delete_data).grid(row=0, column=2, padx=10,
                                                                                             pady=9)
        clearbtn = Button(btn_Frame, text="Clear", width=9, command=self.clear).grid(row=0, column=3, padx=10, pady=9)

        #  Detail  frame ============================================
        Detail_Frame = Frame(self.root, bd=4, relief=RIDGE, bg="crimson")
        Detail_Frame.place(x=500, y=100, width=800, height=585)
        ...
        txt_search = Entry(Detail_Frame, textvariable=self.search_txt, width=20, font=("times new roman", 14, "bold"),
                           bd=5, relief=GROOVE)
